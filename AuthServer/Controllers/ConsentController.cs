...
namespace SwaggerUI.AuthServer.Controllers
{
    ...
    public class ConsentController : Controller
    {
        ...
        public ConsentController(IIdentityServerInteractionService interaction, IClientStore clientStore, IResourceStore resourceStore)
        {
